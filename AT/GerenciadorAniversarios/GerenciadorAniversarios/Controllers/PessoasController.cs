...
namespace GerenciadorAniversarios.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ordenacao, string pesquisa)
        {
            ...
            ViewBag.OrdenacaoDias = string.IsNullOrEmpty(ordenacao) ? "dias_desc" : "";
            ...
            pessoas = ordenacao switch
            {
                "nome_desc" => pessoas.OrderByDescending(pessoa => pessoa.Nome).ToList(),
                "dias_asc" => pessoas.OrderBy(pessoa => pessoa.DiasParaProximoAniversario()).ToList(),
                "dias_desc" => pessoas.OrderByDescending(pessoa => pessoa.DiasParaProximoAniversario()).ToList(),
                _ => pessoas.OrderBy(pessoa => pessoa.DiasParaProximoAniversario()).ToList(),
            };
